...
struct Settings {
    ...
    struct Messages {
        ...
        static let HumanHitMonster = "You've hit a sea monster! The Kraken is coming for you..."
        static let ComputerHitMonster = "The computer has hit a sea monster! Point and laugh as it attacks."
